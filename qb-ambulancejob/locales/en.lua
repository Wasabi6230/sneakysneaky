local Translations = {
    error = {
        ...
        possessions_taken = 'Some of your possessions have been taken...',
    ...
    info = {
        ...
        respawn_revive = 'HOLD [~y~E~s~] FOR ~r~%{holdtime}~w~ SECONDS TO RESPAWN ~b~(NEW LIFE RULE!)~w~ (COST: ~g~$%{cost}~s~)',
        bleed_out = 'YOU WILL BLEED OUT & DIE IN: ~r~%{time}~s~ SECONDS',
        bleed_out_help = 'YOU WILL BLEED OUT & DIE IN: ~r~%{time}~s~ SECONDS',
        request_help = 'PRESS [~g~G~s~] TO REQUEST EMS',
        help_requested = '~g~EMS HAVE BEEN NOTIFIED, PLEASE WAIT',
        ...
        safe = 'Hospital Supplies',
        zonah_hospital = 'St Johns Hospital Mount Zonah',
        paleto_hospital = 'St Johns Hospital Paleto',
        ...
        mr = 'Mr.',
        mrs = 'Mrs.',
        dr_needed = 'A doctor is needed at reception',
    ...
    mail = {
        sender = 'AIA Insurance',
        subject = 'Claim: #725641',
        message = 'Dear %{gender} %{lastname}, <br /><br />Regarding your recent claim for coverage of hospital fees, has been declined as the injuries are not covered by your medical insurance policy.<br /><br />We will not be able to pay out the claim of <strong>$%{costs}.</strong><br /><br />We wish you a quick recovery!'
    },
    states = {
        irritated = 'irritated',
    ...
    text = {
        ...
        call_doc = '[E] - Call doctor (Please take a seat)',
        call = 'Call',
        check_in = '[E] Check in',
        check = 'Check In',
