...
statusChecks = {}
statusCheckTime = 0
-- KRP CUSTOM START (Changes animation for treat wounds instead of CPR)
treatAnimDict = "anim@gangops@facility@servers@"
treatAnim = "hotwire"
-- KRP CUSTOM END
...
-- KRP CUSTOM START (Fixes prison beds)
...
RegisterNetEvent('hospital:client:Revive', function()
	-- KRP CUSTOM START (Turns off voice on dead state, refer to dead.lua for other code)
