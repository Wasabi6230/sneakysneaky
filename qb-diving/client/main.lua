...
local function setDivingLocation(divingLocation)
    ...
    local radiusBlip = AddBlipForRadius(Config.CoralLocations[currentDivingLocation.area].coords.Area, 120.0)
    ...
    local CircleZone = CircleZone:Create(Config.CoralLocations[currentDivingLocation.area].coords.Area, 120.0, {
        name="coral_zone",
        debugPoly=false,
        useZ = true,
    })
