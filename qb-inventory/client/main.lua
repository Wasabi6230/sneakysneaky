...
local function ItemsToItemInfo()
	local itemInfos = {
		...
		-- lightarmor
		[3] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 25x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 35x, "..QBCore.Shared.Items["steel"]["label"] .. ": 50x."},
		-- electronickit
		[4] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 30x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 45x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 28x."},
		-- radioscanner
		[5] = {costs = QBCore.Shared.Items["electronickit"]["label"] .. ": 2x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 52x, "..QBCore.Shared.Items["steel"]["label"] .. ": 40x."},
		-- gatecrack
		[6] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 10x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 50x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 30x, "..QBCore.Shared.Items["iron"]["label"] .. ": 17x, "..QBCore.Shared.Items["electronickit"]["label"] .. ": 1x."},
		-- handcuffs
		[7] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 36x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 24x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 28x."},
		-- engineadd
		...
		-- pistol_ammo
		[9] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 15x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 15x, "..QBCore.Shared.Items["copper"]["label"] .. ": 15x."},
		-- armor
		[10] = {costs = QBCore.Shared.Items["iron"]["label"] .. ": 33x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 44x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 55x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 22x."},
		-- drill
		[11] = {costs = QBCore.Shared.Items["iron"]["label"] .. ": 50x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 50x, "..QBCore.Shared.Items["screwdriverset"]["label"] .. ": 3x, "..QBCore.Shared.Items["advancedlockpick"]["label"] .. ": 2x."},
		-- shotgun_ammo
		[12] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 10x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 15x, "..QBCore.Shared.Items["plastic"]["label"] .. ": 20x."},
		-- heavyarmor
		[13] = {costs = QBCore.Shared.Items["iron"]["label"] .. ": 66x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 88x, "..QBCore.Shared.Items["plastic"]["label"] .. ": 110x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 44x."},
		-- smg_ammo
		[14] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 50x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 25x, "..QBCore.Shared.Items["copper"]["label"] .. ": 5x."},
	}
...
local function SetupAttachmentItemsInfo()
	local itemInfos = {
		...
		[3] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 230x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 365x, "..QBCore.Shared.Items["rubber"]["label"] .. ": 130x."},
		[4] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 255x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 390x, "..QBCore.Shared.Items["rubber"]["label"] .. ": 145x."},
		[5] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 300x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 469x, "..QBCore.Shared.Items["rubber"]["label"] .. ": 170x."},
		[6] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 190x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 305x, " ..QBCore.Shared.Items["rubber"]["label"] .. ": 85x, "..QBCore.Shared.Items["smg_extendedclip"]["label"] .. ": 1x."},
		[7] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 205x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 340x, " ..QBCore.Shared.Items["rubber"]["label"] .. ": 110x, "..QBCore.Shared.Items["smg_drum"]["label"] .. ": 1x."},
		[8] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 36x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 24x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 24x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 28x."},
		...
		[13] = {costs = QBCore.Shared.Items["plastic"]["label"] .. ": 100x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 200x, " ..QBCore.Shared.Items["glass"]["label"] .. ": 900x, " ..QBCore.Shared.Items["aluminum"]["label"] .. ": 100x, " ..QBCore.Shared.Items["rubber"]["label"] .. ": 100x, " ..QBCore.Shared.Items["electronickit"]["label"] .. ": 1x."},
		-- KRP CUSTOM END
	}
...
-- KRP CUSTOM START (Paintball)
local inPaintBall = false
AddEventHandler('l2s-paintball:client:inPaintBall', function(state)
	inPaintBall = state
end)
-- KRP CUSTOM END
...
-- KRP CUSTOM START (Adds progress bar to config.lua and opening inventory)
...
RegisterNetEvent('inventory:client:OpenInventory', function(PlayerAmmo, inventory, other)
	...
	-- PROGRESS BAR
		if Config.Progressbar.Enable then
            QBCore.Functions.Progressbar('open_inventory', 'Opening Pockets...', math.random(Config.Progressbar.minT, Config.Progressbar.maxT), false, true, { -- Name | Label | Time | useWhileDead | canCancel
...
-- KRP CUSTOM START (This is custom weapon crafting because QB does not have it by default.)
RegisterNetEvent('inventory:client:CraftWeapon')
AddEventHandler('inventory:client:CraftWeapon', function(itemName, itemCosts, amount, toSlot, points)
    local ped = PlayerPedId()
    SendNUIMessage({
        action = "close",
    })
...
RegisterNetEvent('inventory:client:CraftDrug')
AddEventHandler('inventory:client:CraftDrug', function(itemName, itemCosts, amount, toSlot, points)
    local ped = PlayerPedId()
    SendNUIMessage({
        action = "close",
    })
    ...
    QBCore.Functions.Progressbar("repair_vehicle", "Crafting..", (math.random(2000, 5000) * amount), false, true, {
		...
		StopAnimTask(ped, "mini@repair", "fixing_a_player", 1.0)
        TriggerServerEvent("inventory:server:CraftDrug", itemName, itemCosts, amount, toSlot, points)
        TriggerEvent('inventory:client:ItemBox', QBCore.Shared.Items[itemName], 'add')
        isCrafting = false
	end, function() -- Cancel
		StopAnimTask(ped, "mini@repair", "fixing_a_player", 1.0)
...
RegisterNetEvent('inventory:client:UseWeapon', function(weaponData, shootbool)
    ...
    elseif weaponName == "weapon_snowball" then
        GiveWeaponToPed(ped, weaponHash, 20, false, false)
        SetPedAmmo(ped, weaponHash, 20)
        SetCurrentPedWeapon(ped, weaponHash, true)
...
-- KRP CUSTOM START (Added trunk sizes/types and paintball)
RegisterCommand('inventory', function()
	-- PAINTBALL
	if GetResourceState("l2s-paintball") == "started" then 
        if exports['l2s-paintball']:IsPlayerInPB() then
            QBCore.Functions.Notify('Cannot open pockets in here!', 'error', 3500)
            return
        end
    end
	-- PAINTBALL END
        ...
        if not PlayerData.metadata["isdead"] and not PlayerData.metadata["inlaststand"] and not PlayerData.metadata["ishandcuffed"] and not IsPauseMenuActive() then
            ...
            if CurrentVehicle then -- Trunk
                ...
                elseif vehicleClass == 8 then -- Motorcycles
                    maxweight = 600000
                    slots = 15
                elseif vehicleClass == 10 then -- Off-road
                    maxweight = 750000
                    slots = 35
                elseif vehicleClass == 11 then -- Industrial
                    maxweight = 750000
                    slots = 35					
				elseif vehicleClass == 9 then -- Utility
                    maxweight = 750000
                    slots = 35
				...
				elseif vehicleClass == 21 then -- Trains
                    maxweight = 1500000
                    slots = 50
				elseif vehicleClass == 22 then -- Open Wheel
                    maxweight = 1500000
                    slots = 50					
                else
                    maxweight = 600000
