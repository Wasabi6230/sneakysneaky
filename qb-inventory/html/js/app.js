...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
		...
		// KRP CUSTOM START
		} else if (itemData.name == "rolledbills") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Worth: </strong><span>$" +
                itemData.info.worth +
        ...
        } else if (itemData.name == "casino_hotelcard") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p><strong>Room: </strong>" + itemData.info.room + "</p><p><strong>Name: </strong>" + itemData.info.owner + "</p><p><strong>Citizen ID: </strong>" + itemData.info.citizenid + "</p><p><strong>Check-out: </strong>" + itemData.info.expire + "</p>");
        } else if (itemData.name == "casino_accesscode1") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Access Code Part 1: <b>" + itemData.info.code + "</b></p>");
        } else if (itemData.name == "casino_accesscode2") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Access Code Part 2: <b>" + itemData.info.code + "</b></p>");
        ...
        // KRP CUSTOM START (nzkfc - vehicle plate item from loyalty)
		} else if (itemData.name == "vehplate") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Licenseplate:</strong> ' + itemData.info.platenr + '</p>');	
		// KRP CUSTOM END} else {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    handleDragDrop();
	// KRP CUSTOM START (temp fix for f8 dupe https://github.com/qbcore-framework/qb-inventory/pull/407/files)
	//Inventory.Close();
	// KRPC CUSTOM END
}
...
(() => {
    ...
    Inventory.ToggleHotbar = function(data) {
        if (data.open) {
            ...
            //KRP CUSTOM START (Hides slot 6 on hotbar) 
			// var elem =
