...
Config.Plates = {
    [1] = {
        coords = vector4(-913.71, -717.83, -71.7, 347.82),
        boxData = {
            heading = 340,
            length = 5,
            width = 2.5,
...
Config.Locations = {
    ["exit"] = vector3(-913.71, -717.83, -71.7),
    ["duty"] = vector3(-913.71, -717.83, -71.7),
    ["stash"] = vector3(-913.71, -717.83, -71.7),
    ["vehicle"] = vector4(-913.71, -717.83, -71.7, 347.82),
}
