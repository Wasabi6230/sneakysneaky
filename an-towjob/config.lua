...
Config.BailPrice = 0 -- How much the worker gets charged to get a truck, this is disabled.
Config.Phone = 'gks' -- qb / gks / qs
Config.dropprice = math.random(500,1200) -- Price of each dropoff
...
Config.PedHash = 's_m_y_garbage'
Config.PedPos = vector4(374.43, -1616.49, 29.29, 236.79)
Config.payPedHash = 's_m_y_garbage'
Config.payPedPos = vector4(408.04, -1623.91, 29.29, 227.7)
Config.Locations = {
    ["main"] = {
        label = "Tamaki's Towyard",
        coords = vector4(423.7, -1638.22, 29.46, 266.57),
    },
    ["vehicle"] = {
        label = "Flatbed",
        coords = vector4(376.31, -1612.4, 29.38, 230.28),
    },
    ["towspots"] = {
