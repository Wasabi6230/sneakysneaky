                ...
                items = {
                    {
                        ...
                        id = 'uncarry',
                        title = 'Jump off Shoulders',
                        icon = 'user-group',
                        type = 'client',
                        event = 'cc-carry:client:stop',
                        shouldClose = true
                    }, {
                        id = 'escort554',
                        title = 'Hostage',
                ...
                items = {
                    ...
                    -- }, 
					{
                        ...
                        items = {
							...
							-- KRP CUSTOM START (Disabled as we don't allow setting)
							-- , {
                                -- id = 'setlogout',
                                -- title = 'Set Logout',
                                -- icon = 'door-open',
    ...
    ["ambulance"] = {
        {
            ...
            icon = 'user-doctor',
            type = 'client',
            event = 'hospital:client:RevivePlayerNoEmote',
            shouldClose = true
        },{
            id = 'treatwounds',
            title = 'Heal wounds',
			...
			id = 'treatwoundsnoemote',
            title = 'Heal wounds (NE)',
            icon = 'bandage',
            type = 'client',
            event = 'hospital:client:TreatWoundsNoEmote',
            shouldClose = true
        }, {
            id = 'emergencybutton2',
            ...
            items = {
                {
                    ...
                    icon = 'shield',
                    type = 'client',
                    event = 'krpshield:TogglePoliceShield',
                    shouldClose = true
                }, {
                    id = 'aosshield',
                    title = 'AOS Shield',
                    icon = 'shield',
                    type = 'client',
                    event = 'krpshield:ToggleAOSShield',
                    shouldClose = true
                }
            }
        }, {
...
Config.Commands = {
    ...
    ["decals"] = {
        Func = function() ToggleClothing("Decals") end,
        Sprite = "decal",
