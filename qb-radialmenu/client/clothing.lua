...
CreateThread(function()
	...
	addNewVariation("hair", "male", 122, 120, true)
	addNewVariation("hair", "male", 106, 63, true)
	addNewVariation("hair", "male", 74, 66, true)
	addNewVariation("hair", "male", 135, 131, true)
	addNewVariation("hair", "male", 131, 135, true)	
	addNewVariation("hair", "male", 85, 86, true)
	addNewVariation("hair", "male", 89, 111, true)
	addNewVariation("hair", "male", 111, 89, true)
	addNewVariation("hair", "male", 96, 97, true)	
	addNewVariation("hair", "male", 97, 96, true)
	addNewVariation("hair", "male", 121, 3, true)
	addNewVariation("hair", "male", 82, 3, true)	
	addNewVariation("hair", "male", 122, 119, true)	
	addNewVariation("hair", "male", 127, 86, true)
	addNewVariation("hair", "male", 130, 86, true)	
	-- female hair
	...
	addNewVariation("hair", "female", 141, 137, true)	
	addNewVariation("hair", "female", 140, 137, true)
	addNewVariation("hair", "female", 135, 137, true)
	addNewVariation("hair", "female", 133, 137, true)	
	addNewVariation("hair", "female", 132, 137, true)	
	addNewVariation("hair", "female", 131, 137, true)	
	addNewVariation("hair", "female", 129, 128, true)
	addNewVariation("hair", "female", 127, 137, true)	
	addNewVariation("hair", "female", 114, 137, true)	
	addNewVariation("hair", "female", 111, 137, true)	
	addNewVariation("hair", "female", 109, 137, true)	
	addNewVariation("hair", "female", 108, 137, true)
	addNewVariation("hair", "female", 106, 137, true)	
	addNewVariation("hair", "female", 102, 137, true)	
	addNewVariation("hair", "female", 100, 137, true)	
	addNewVariation("hair", "female", 98, 137, true)	
	addNewVariation("hair", "female", 88, 137, true)
	addNewVariation("hair", "female", 87, 137, true)
	addNewVariation("hair", "female", 86, 137, true)
	addNewVariation("hair", "female", 85, 137, true)
	addNewVariation("hair", "female", 83, 137, true)
	addNewVariation("hair", "female", 81, 137, true)
	addNewVariation("hair", "female", 88, 137, true)
	addNewVariation("hair", "female", 88, 137, true)
...
local Extras = {
	...
	["Undershirt"] = {
		Drawable = 8,
		Table = {Standalone = true, male = 15, female = 14},
		Emote = {Dict = "clothingtie", Anim = "try_tie_negative_a", Move = 51, Dur = 1200}
	},	
}
...
local Props = {
	...
	["Hat"] = {
		Prop = 0,
		Emote = {
			On = {Dict = "mp_cp_stolen_tut", Anim = "b_think", Move = 51, Dur = 1200},
			Off = {Dict = "mp_cp_stolen_tut", Anim = "b_think", Move = 51, Dur = 1200}
		}
	},
	["Glasses"] = {
		Prop = 1,
...
function ToggleClothing(whic, extra)
    ...
    if which == "Shirt" or which == "Pants" or which == "Bagoff" or which == "Decals" or which == "Undershirt" then
        extra = true
    end
