--- IMAGE CONFIG HERE ---
-- imageUrl = "https://i.imgur.com/BnslrGu.png" -- Paste your image URL here (doesn't have to be from imgur)
imageUrl = "https://i.imgur.com/eR2yVHX.png"
...
AddReplaceTexture('vehshare', 'yankton_plate', 'duiTxd', 'duiTex') -- Applies "duiTex" from "duiTxd" to "plate05" from "vehshare"
...
AddReplaceTexture('vehshare', 'yankton_plate_n', 'duiTxd', 'duiTex2') -- Applies "duiTex2" from "duiTxd" to "plate05_n" from "vehshare"
