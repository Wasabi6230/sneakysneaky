...
Config.DisplaySettings = {
    time = 120000, -- time in ms for the ped being displayed
...
Locales = {
    ["pressinfo"] = "[~g~E~w~] Copy ~r~info ~w~to your clipboard",
    ["detailClipboard"] = "Details copied, please paste this into a Discord support ticket."
}
