...
--SERVER SETTINGS
Config.HouseType = "OnlyMission" -- AllHouses | OnlyMission | Both
Config.InteractionType = "target" -- target or textui | which type of interaction you want
...
Config.TimeSync = "none" -- Time Sync | types: cd_easytime, none
...
Config.Tier = {
        ...
        InsidePositions = {
            ...
            ["Saffron"] = {
                ...
                Items = {
                    ...
                    { Item = "plastic", Chance = 70.5, MinCount = 1, MaxCount = 10 },
                    { Item = "bong", Chance = 80.5, MinCount = 1, MaxCount = 2 },
                    { Item = "tosti", Chance = 80.5, MinCount = 1, MaxCount = 5 },
                    { Item = "blindfold", Chance = 80.5, MinCount = 1, MaxCount = 1 },
                }
            },
        },
        ...
        Safes = {
            ...
            ChanceToFindNothing = 0,
                Items = {
                    ...
                    { Item = "rolex", Chance = 90.5, MinCount = 1, MaxCount = 2 },
                    { Item = "diamond_ring", Chance = 90.5, MinCount = 1, MaxCount = 2 },
                    { Item = "gold_bracelet", Chance = 90.5, MinCount = 1, MaxCount = 2 },
                    { Item = "goldchain", Chance = 90.5, MinCount = 1, MaxCount = 2 },
                    { Item = "earings", Chance = 90.5, MinCount = 1, MaxCount = 2 },
                    { Item = "usb_green", Chance = 15.5, MinCount = 1, MaxCount = 1 },
                },
            }
        },
        Ped = {
            chance = 100, model = `s_m_y_dealer_01`, coords = vec4(262.6, -1004.04, -99.26, 86.94)
        },
    ...
    ["Mid Tier"] = {
        chance = 35, -- change in mission to get this house type
        ...
        InsidePositions = {
            ...
            ["Bag of Cocaine"] = {
                ...
                Items = {
                    ...
                    { Item = "bong", Chance = 80.5, MinCount = 1, MaxCount = 2 },
                    { Item = "tosti", Chance = 80.5, MinCount = 1, MaxCount = 5 },
                    { Item = "mortar", Chance = 80.5, MinCount = 1, MaxCount = 1 },
                    { Item = "blindfold", Chance = 80.5, MinCount = 1, MaxCount = 1 },
                },
            },
            ["Book"] = {
                ...
                Items = {
                    ...
                    { Item = "romantic_book", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                    { Item = "bible", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                }
            },
            ["Bathroom"] = {
                ChanceToFindNothing = 10,
                ...
                Items = {
                    ...
                    { Item = "empty_pill", Chance = 80.5, MinCount = 1, MaxCount = 5 },
                    { Item = "empty_pillbottle", Chance = 80.5, MinCount = 1, MaxCount = 5 },
                },
            },
        },
        CreateProps = { -- Spawned props by script
        ...
        Safes = {
            ["safe"] = { model = `prop_ld_int_safe_01`, Label = "Safe", NeedItem = true, Item = "lockpick", Coords = vec4(352.34, -994.44, -100.2, 273.98),
                ...
                Items = {
                    ...
                    { Item = "security_card_01", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                    { Item = "usb_green", Chance = 24.5, MinCount = 1, MaxCount = 1 },
                },
            },
        },
        Ped = {
            chance = 100, model = `a_m_y_soucent_04`, coords = vec4(349.83, -996.29, -99.54, 270.66)
        },
        StaticProps = { --Props that are already in interior
    ...
    ["High Tier"] = {
        chance = 15, -- change in mission to get this house type
        ...
        InsidePositions = {
            ...
            ["Saffron"] = {
                ...
                Items = {
                    ...
                    { Item = "earings", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                    { Item = "finescale", Chance = 30.9, MinCount = 1, MaxCount = 1 },
                    { Item = "thermite", Chance = 20.9, MinCount = 1, MaxCount = 1 },
                    { Item = "thermite", Chance = 35.9, MinCount = 1, MaxCount = 1 },                   
                }
            },
            ["Kitchen #1"] = { 
                ChanceToFindNothing = 35,
            ...
            ["Kitchen #2"] = {
                ...
                Items = {
                    ...
                    { Item = "weapon_bottle", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                    { Item = "tosti", Chance = 80.5, MinCount = 1, MaxCount = 5 },
                    { Item = "fooddehydrator", Chance = 80.5, MinCount = 1, MaxCount = 1 },
                    { Item = "trimming_scissors", Chance = 80.5, MinCount = 1, MaxCount = 1 },
                }
            },
            ["Heist storage"] = {
                ChanceToFindNothing = 95,
                coords = vector3(-794.997680, 326.787872, 187.313340),        
                Items = {
                    { Item = "weapon_microsmg", Chance = 30.9, MinCount = 1, MaxCount = 2 },
            ...
            ["Locker #2"] = {
                ...
                Items = {
                    ...
                    { Item = "weapon_bottle", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                    { Item = "weapon_bat", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                    { Item = "weapon_golfclub", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                },
            },
            ["Bathroom"] = {
                ChanceToFindNothing = 35,
        ...
        Safes = {
            ["safe"] = { model = `prop_ld_int_safe_01`, Label = "Safe", NeedItem = true, Item = "lockpick", Coords = vec4(-797.56, 339.19, 190.02, 0.27),
                ...
                Items = {
                    ...
                    { Item = "earings", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                    { Item = "necklace", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                    { Item = "usb_green", Chance = 30.9, MinCount = 1, MaxCount = 2 },
                    { Item = "bp_shotgun_frag1", Chance = 20.9, MinCount = 1, MaxCount = 1 },
                    { Item = "bp_shotgun_frag2", Chance = 17.9, MinCount = 1, MaxCount = 1 },
                    { Item = "bp_shotgun_frag3", Chance = 15.9, MinCount = 1, MaxCount = 1 },
                    { Item = "bp_shotgun_frag4", Chance = 13.9, MinCount = 1, MaxCount = 1 },
                },
            }
        },
        Ped = {
            chance = 100, model = `a_m_y_soucent_04`, coords = vec4(-797.98, 335.78, 190.39, 1.37)
        },
        StaticProps = { --Props that are already in interior
...
Config.HousesToRob = {
    ["Low Tier 1"] = {
        Coords = vec3(443.36, -1707.34, 29.71),
        Residence = Config.Tier["Low Tier"],
        Hints = {
            'HINT: There are two wheelie bins outside',
            'HINT: CHB tagged on the wall',
            'HINT: Blue tarp on the roof',
            'HINT: Across the road from a tall building',
            'HINT: Can hear loud tow trucks'
        }
    },
    ["Low Tier 2"] = {
...
Config.Shop = {
    Header = "Shady Dealer",
    Items = {
        { label = 'Laser Powder', item = 'powder', description = "Buy Laser discovering powder for: $", price = 200, MinAmount = 1, MaxAmount = 20},
        { label = 'Hacking laptop', item = 'hack_laptop', description = "Buy Laptop for: $", price = 5000, MinAmount = 1, MaxAmount = 2 },
        { label = 'Lockpick', item = 'lockpick', description = "Buy Lockpick for: $", price = 100, MinAmount = 1, MaxAmount = 20 },
        { label = 'Duffle bag', item = 'loot_bag', description = "Buy Duffle Bag for: $", price = 1000, MinAmount = 1, MaxAmount = 20 },
        { label = 'House Locator', item = 'house_locator', description = "Buy Locator for: $", price = 1000, MinAmount = 1, MaxAmount = 20 },
    },
    Ped = {
        model = `s_m_y_waretech_01`, 
        coords = vec4(188.0, 308.46, 104.39, 186.54), 
...
--SellShop
Config.SellShop = {
    Header = "Illegal Buyer",
    Items = {
        { label = 'TV', item = 'television', description = "Sell Square TV for: $", price = 500, MinAmount = 1, MaxAmount = 20},
        { label = 'Shoe Box', item = 'shoebox', description = "Sell Shoe Box for: $", price = 200, MinAmount = 1, MaxAmount = 2},
        { label = 'DJ deck', item = 'dj_deck', description = "Sell DJ deck for: $", price = 600, MinAmount = 1, MaxAmount = 20 },
        { label = 'Console', item = 'console', description = "Sell console for: $", price = 450, MinAmount = 1, MaxAmount = 20 },
        { label = 'Boombox', item = 'boombox', description = "Sell boombox for: $", price = 750, MinAmount = 1, MaxAmount = 20 },
        { label = 'Bong', item = 'bong', description = "Sell bong for: $", price = 250, MinAmount = 1, MaxAmount = 20 },
        { label = 'Pogo Statue', item = 'pogo', description = "Sell Art Piece for: $", price = 3250, MinAmount = 1, MaxAmount = 20 },
        { label = 'Flat Television', item = 'flat_television', description = "Sell Flat Television for: $", price = 2500, MinAmount = 1, MaxAmount = 20 },
        { label = 'Coffe', item = 'coffemachine', description = "Sell Coffe for: $", price = 450, MinAmount = 1, MaxAmount = 20 },
        { label = 'Hairdryer', item = 'hairdryer', description = "Sell hairdryer for: $", price = 100, MinAmount = 1, MaxAmount = 20 },
        { label = 'Phone', item = 'j_phone', description = "Sell Phone for: $", price = 200, MinAmount = 1, MaxAmount = 20 },
        { label = 'Sculpture', item = 'sculpture', description = "Sell sculpture for: $", price = 1500, MinAmount = 1, MaxAmount = 20 },
        { label = 'Toiletry', item = 'toiletry', description = "Sell toiletry for: $", price = 100, MinAmount = 1, MaxAmount = 20 },
        { label = 'Laptop', item = 'laptop', description = "Sell Laptop for: $", price = 400, MinAmount = 1, MaxAmount = 20 },
        { label = 'Monitor', item = 'monitor', description = "Sell monitor for: $", price = 400, MinAmount = 1, MaxAmount = 20 },
        { label = 'Printer', item = 'printer', description = "Sell Printer for: $", price = 300, MinAmount = 1, MaxAmount = 20 },
        { label = 'Watch', item = 'watch', description = "Sell Watch for: $", price = 450, MinAmount = 1, MaxAmount = 20 },
        { label = 'Toothpaste', item = 'toothpaste', description = "Sell toothpaste for: $", price = 40, MinAmount = 1, MaxAmount = 20 },
        ...
        { label = 'Necklace', item = 'necklace', description = "Sell necklace for: $", price = 7500, MinAmount = 1, MaxAmount = 20 },
        { label = 'Gold watch', item = 'gold_watch', description = "Sell gold watch for: $", price = 1500, MinAmount = 1, MaxAmount = 20 },
        { label = 'Gold Rolex watch', item = 'rolex', description = "Sell gold rolex watch for: $", price = 1750, MinAmount = 1, MaxAmount = 20 },
        { label = 'Gold bracelet', item = 'gold_bracelet', description = "Sell gold bracelet for: $", price = 1000, MinAmount = 1, MaxAmount = 20 },
        { label = 'Gold chain', item = 'goldchain', description = "Sell gold chain for: $", price = 1150, MinAmount = 1, MaxAmount = 20 },
        { label = 'Diamond ring', item = 'diamond_ring', description = "Sell Diamond ring for: $", price = 2500, MinAmount = 1, MaxAmount = 20 },
        { label = 'Bracelet', item = 'bracelet', description = "Sell bracelet for: $", price = 250, MinAmount = 1, MaxAmount = 20 },
        { label = 'Earings', item = 'earings', description = "Sell earings for: $", price = 550, MinAmount = 1, MaxAmount = 20 },
        { label = 'Book', item = 'book', description = "Sell book for: $", price = 10, MinAmount = 1, MaxAmount = 20 },
        { label = 'Skull Art', item = 'skull', description = "Sell skull for: $", price = 4000, MinAmount = 1, MaxAmount = 20 },
