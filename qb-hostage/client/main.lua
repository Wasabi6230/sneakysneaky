...
function takeHostage()
	...
	if closestPlayer ~= nil and closestPlayer ~= -1 then
		...
		if NoWeapon then
			TriggerClientEvent('QBCore:Notify', src, 'You cannot use this weapon to take hostages!', 'error')
			return
		end
		...
		TriggerClientEvent('QBCore:Notify', src, 'Nobody is close enough!', 'error')
	end
