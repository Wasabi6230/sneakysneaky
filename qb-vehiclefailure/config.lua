...
-- IMPORTANT: Some of these values MUST be defined as a floating point number. ie. 10.0 instead of 10
	...
	Config.Price = 750
	--KRP CUSTOM START
	Config.Engineaddvalue = 250.0 -- This is how much the engine repairs to when using engineadd item, must be float value e.g. 1.0 and total health is 1000
	Config.Oiladdvalue = 400.0 -- This is how much the oil level goes too when using engineadd item, must be float value e.g. 1.0 and total oil is 1000
	
	Config.RoadsideKitRepair = 500.0 -- This is how much the engine and oil level repairs to when using roadsidekit item, must be float value e.g. 1.0 and total health is 1000
	--KRP CUSTOM END
