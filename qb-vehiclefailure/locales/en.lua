local Translations = {
    error = {
        ...
        ["healthy_veh"] = "Vehicle is too damanged for this repair kit type!",
    ...
    success = {
		...
		-- KRP CUSTOM START
		["repaired_veh_roadside"] = "Customer's vehicle repaired!",
		["repaired_veh_puncturekit"] = "Tyre has been repaired!",
		["repaired_veh_engineadd"] = "Engine fixed, but you need to see a mechanic soon!",
		-- KRP CUSTOM END
    ...
    progress = {
		...
		-- KRP CUSTOM START (For split repair functions in city)
		["roadside_veh"] = "Repairing customers vehicle...",
		["puncturekit_veh"] = "Repairing tyre puncture...",
		["engineadd_veh"] = "Repairing engine with additive...",
		-- KRP CUSTOM END
    }
}
