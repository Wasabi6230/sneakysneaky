...
if Config.Toggle then
    RegisterCommand('scoreboard', function()
        if not scoreboardOpen then
            -- KRP CUSTOM START
			QBCore.Functions.TriggerCallback('qb-scoreboard:server:GetScoreboardData', function(players, cops, ems, corrections, playerList)
			-- KRP CUSTOM END
...
-- disabled to stop people seeing admins
-- CreateThread(function()
    -- while true do
        -- local loop = 100
