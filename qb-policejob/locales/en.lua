local Translations = {
    error = {
        ...
        -- KRP CUSTOM START
        on_duty_police_only = 'For on-duty police only (and Tow workers)',
		prison_grade = 'Restricted Access - Police Only.',
        -- KRP CUSTOM END
    ...
    info = {
        ...
        bill = 'Bill',
        amount = 'Amount',
        police_plate = 'ZPK7', --Should only be 4 characters long
        ...
        trash = 'Trash',
		-- KRP CUSTOM START
        trash_enter = '[E] Trash Bin (Police Only)',
		-- KRP CUSTOM END
    ...
    evidence = {
        ...
        -- KRP CUSTOM START
		tobacco_smell = 'Smells like ciggie butt brain...',
		-- KRP CUSTOM END
    },
    menu = {
    ...
    commands = {
        ...
        clearblood = 'Clear The Area of Blood (Police/EMS Only)',
