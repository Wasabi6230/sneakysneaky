...
Config.MugShotWebhook = 'https://discord.com/api/webhooks/1095185307470663791/q0N2zQu2-uhCYNGaTIgawSyylYsJrkhDFXUh39QsFD5IycZYoGGh9RyBqOM0HV_WVa9r'

-- Clock-in notifications for duty. Add a Discord webhook.
-- Command /mdtleaderboard, will display top players per clock-in hours.
Config.ClockinWebhook = 'https://discord.com/api/webhooks/1095185559900655688/3PqGAyfQwkrCxaYxXixtqYWoYx-4koyhT9gzUWqEChLoB12RXl_aVg7mdY2PZUMXUSpK'
...
-- Google Docs Link
Config.sopLink = {
    ['police'] = 'https://docs.google.com/document/d/1FcqEhxAw1KArwLvpbYCWSbfwK5b3BbkO4HNNI4adtSc/edit?usp=sharing',
    ['ambulance'] = '',
    ['bcso'] = '',
    ['doj'] = '',
    ['sast'] = '',
...
-- Google Docs Link
Config.RosterLink = {
    ['police'] = 'https://docs.google.com/spreadsheets/d/14FkJJy1tQuku4cWQoHee6ZsXDm6piyv4XnoJlP5DnwE/edit#gid=0',
    ['ambulance'] = '',
    ['bcso'] = '',
    ['doj'] = '',
    ['sast'] = '',
...
Config.ImpoundLocations = {
    [1] = vector4(423.41, -991.95, 21.34, 178.29),
    [2] = vector4(-459.79, 6041.48, 31.34, 38.22),
}
