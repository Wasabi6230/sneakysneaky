				...
				if distance < 1.5 then
					...
					if(IsControlJustReleased(1, 38))then
						...
						if (tmp_action.type == "cleaning") then
							...
							local vassouspawn = CreateObject(`prop_leaf_blower_01`, cSCoords.x, cSCoords.y, cSCoords.z, 1, 1, 1)
							local netid = ObjToNet(vassouspawn)

							TaskStartScenarioInPlace(PlayerPedId(), "world_human_gardener_leaf_blower", 0, false)
