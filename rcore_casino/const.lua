...
stringValues = {{"SLOTS_RT_BET", "Bet"}, {"SLOTS_RT_LSTWIN", "Last Win"}, {"SLOTS_MESN101", "Barf Me Out!"},
                ...
                {"SLOTS_MESN411", "On the list!"}, {"SLOTS_MESP411", "You're #1"},
...
LuckyWheelRandomItems = {{
    inventoryName = "diamond", -- item (inventory) name/key, case sensitive
    title = "Diamond", -- title for the Lucky Wheel reward message
    amount = {1, 5} -- amount (random between 1 to 10)
}, {
    inventoryName = "goldbar", -- item (inventory) name/key, case sensitive
    title = "Gold Bar", -- title for the Lucky Wheel reward message
    amount = {2, 4}
}}
...
AMBIENT_TABLES_PED_SKINS = {"a_f_m_bevhills_01", "a_m_m_bevhills_01", "a_m_m_fatlatin_01", "a_f_y_bevhills_04",
                            "a_f_y_femaleagent", "a_f_y_smartcaspat_01", "a_m_m_mexlabor_01", "a_m_y_bevhills_01",
                            "a_m_y_beachvesp_01", "a_f_y_vinewood_04", "a_f_y_hipster_02", "a_f_y_hipster_01",
                            "a_f_y_business_02", "a_f_y_clubcust_02"}
...
WAITRESS_MODEL = "s_m_y_waiter_01" -- set to nil if you want to disable the walking waitress
