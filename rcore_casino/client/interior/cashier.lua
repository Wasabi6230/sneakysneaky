...
function Cashier_RequestVIP()
    ...
    local message = string.format(Translation.CASHIER_VIP_CONFIRM_MSG, FormatPrice(Config.CASHIER_VIP_PRICE))
    if Config.CASHIER_VIP_DURATION then
        message = message .. string.format(Translation.CASHIER_VIP_CONFIRM_MSG_2, FormatTimestamp(Config.CASHIER_VIP_DURATION))
    end
