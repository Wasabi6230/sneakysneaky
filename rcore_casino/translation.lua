Translation = {
    ...
    CASHIER_PRESS_TO_USE = "Press ~INPUT_TALK~ to use cashier",
    ...
    PPODIUM_INFO = "~BLIP_681~ Come over to the Lucky Wheel and try your luck in winning this car!",
    PODIUM_INFO_2 = "",
    PODIUM_INFO_3 = "~BLIP_681~ The Lucky Wheel currently doesn't offer any vehicle.",
    PODIUM_INFO_4 = "Nothing to see here...",
}
