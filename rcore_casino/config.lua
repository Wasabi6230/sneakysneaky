Config = {
    ...
    ChipsInventoryItem = "casino_whitechip",
    ...
    IT_MAIN_EVENT_MIN_PLAYERS = 2, -- min. players needed for the main event to start; def: 2
    ...
    IT_MAIN_EVENT_BETTING_TIME = 60 * 2, -- time for players to place bets for main event, shows horses on screen; def: 60 * 5 (5 minutes)
    IT_MAIN_EVENT_RACE_DURATION = 45, -- length of the main event race; def: 33
    ...
    IT_MAIN_EVENT_RACE_MAX_BET = 20000, -- max. bet for the main event race
    IT_MAIN_EVENT_RACE_MIN_BET = 1000, -- min. bet for the main event race
    
	IT_LOCAL_RACE_DURATION = 60, -- length of the local race (orange screen) def: 30
    ...
    IT_LOCAL_RACE_WIN_CHANCE = 90, -- win chance (from 0 to 100), def: 100, 100 means that it's not *unlucky* on purpose
    ...
    LUCKY_WHEEL_PAY_TO_SPIN = 8000, -- set price for the spin (chips), set 0 for free spins, or set to existing inventory name, for example LUCKY_WHEEL_PAY_TO_SPIN = "wheel_ticket" to pay with an inventory item
