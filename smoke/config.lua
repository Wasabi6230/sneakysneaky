...
------------- BUTTONS 
Config.DisableCombatButtons = false -- Deactivates the attack buttons while smoking
...
Config.Smoke = { -- Item = 
    {Item = "cubancigar",  Prop = 'prop_cigar_01', Armor = 5, Stress = 5, Size = 20, Type = 'cigar', Time = 500},
    {Item = "davidoffcigar",  Prop = 'prop_cigar_01', Armor = 5, Stress = 5, Size = 20, Type = 'cigar', Time = 500},
    {Item = "redwcig",  Prop = 'ng_proc_cigarette01a', Armor = 5, Stress = 5, Size = 20, Type = 'cigarette', Time = 500},
    {Item = "marlborocig",  Prop = 'ng_proc_cigarette01a', Armor = 5, Stress = 5, Size = 20, Type = 'cigarette', Time = 500},
    {Item = "vape",  Prop = 'ba_prop_battle_vape_01', Armor = 5, Stress = 0, Size = 0, Type = 'vape', Time = 0},
    {Item = "bong",  Prop = 'prop_bong_01', Armor = 5, Stress = 5, Size = 0, Type = 'bong', Time = 0},
    -- {Item = "og_kush_joint",  Prop = 'prop_sh_joint_01', Armor = 5, Stress = 5, Size = 20, Type = 'joint', Time = 500},
    -- {Item = "blue_dream_joint",  Prop = 'prop_sh_joint_01', Armor = 5, Stress = 5, Size = 20, Type = 'joint', Time = 500},
    -- {Item = "purple_haze_joint",  Prop = 'prop_sh_joint_01', Armor = 5, Stress = 5,Size = 20, Type = 'joint', Time = 500},
    -- {Item = "banana_kush_joint",  Prop = 'prop_sh_joint_01', Armor = 5, Stress = 5, Size = 20, Type = 'joint', Time = 500},
	{Item = "joint",  Prop = 'prop_sh_joint_01', Armor = 5, Stress = 5, Size = 20, Type = 'joint', Time = 500},
}
...
Config.RollingJoints = {  -- Weed bag -- amount = How many joints you get
	...
	{Item = "driedweed",  GiveJoint = 'joint', Amount = 1},
	{Item = "tinnie",  GiveJoint = 'joint', Amount = 3},
}
