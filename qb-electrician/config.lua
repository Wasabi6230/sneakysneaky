...
Config.JobPrice = math.random(2500, 5000) -- Amount made per job completed. Note: This isn't the final amount as there is scripted bonuses for payments as well.
...
Config.Locations = {
    ...
    ["jobset1"] = {
        ...
        [5] = {
            name = "Job Site 5",
            coords = vector4(551.06896, -153.4105, 57.035686, 96.05545),
        },
    },
    ["jobset2"] = {
        [1] = {
