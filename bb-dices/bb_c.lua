...
AddEventHandler("bb-dices:ToggleDiceAnim", function()
    TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 2.0, 'dice-cup', 0.3)
	Citizen.Wait(900)
...
RegisterNetEvent("bb-dices:ToggleRPSAnim")
AddEventHandler("bb-dices:ToggleRPSAnim", function()
    loadAnimDict("anim@mp_player_intcelebrationmale@wank")
    TaskPlayAnim(PlayerPedId(), "anim@mp_player_intcelebrationmale@wank", "wank", 8.0, 1.0, -1, 49, 0, 0, 0, 0)
    Citizen.Wait(1000)
