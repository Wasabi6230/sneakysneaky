...
CreateThread(function()
    ...
    local coords = {
        vector4(1763.7, 2576.90, 46.50, 0.91), -- cells
        vector4(1761.36, 2598.89, 46.10, 49.1) -- canteen
    }
...
RegisterNetEvent('qb-jail:client:ChangeJob', function(selectedJob)
    ...
    elseif selectedJob == 'workout' then
        ...
        createJobTaskBlip(vector3(1749.4794, 2528.6728, 45.564933), 'Workout', 311, true)
        createJobTaskBlip(vector3(1643.7252, 2529.2204, 45.560989), 'Workout', 311, true)
        createJobTaskBlip(vector3(1769.2451, 2589.7048, 45.839839), 'Workout', 311, true)
    ...
    elseif selectedJob == 'kitchen' then
        QBCore.Functions.TriggerCallback('qb-jail:server:GetCurrentKitchenTask', function(label, progress)
            if label and progress then
                ...
                createJobTaskBlip(vector3(1779.6297, 2594.2131, 45.797824), 'Kitchen', 436, true)
    ...
    elseif selectedJob == 'scrapyard' then
        createJobTaskBlip(vector3(1632.84, 2510.31, 45.56), 'Scrapyard', 728, true)
        QBCore.Functions.Notify('Make your way to the yard for work!', 'primary', 2500)
    ...
    elseif selectedJob == 'lockup' then
        createJobTaskBlip(vector3(1777.8209, 2579.0566, 45.797805), 'Lockup', 730, true)
