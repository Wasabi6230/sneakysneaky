...
RegisterNetEvent('qb-jail:client:OutsideHack', function()
    ...
    if QBCore.Functions.HasItem('gatecrack') then
...
CreateThread(function()
    ...
    exports['qb-target']:AddBoxZone('jailbreak_outsidethermite_4', vector3(1791.0129, 2561.4331, 45.564918), 1.0, 0.5, {
        name = 'jailbreak_outsidethermite_4',
        heading = 0,
        debugPoly = false,
        minZ = 44.20,
        maxZ = 46.80
        ...
        options = { 
            {
                ...
                index = 4,
                canInteract = function()
                    return Config.JailBreak.PowerplantHit and not Config.JailBreak.Thermite[4][4] and Config.JailBreak.VARHack
                end
            }
        },
        distance = 1.5,
    ...
    exports['qb-target']:AddBoxZone('jailbreak_outsidehack_1', vector3(1831.31, 2603.95, 45.89), 0.6, 1.4, {
    ...
    exports['qb-target']:AddBoxZone('jailbreak_cell_panel', vector3(1777.68, 2591.99, 50.55), 2.2, 1.4, {
        ...
        options = { 
            ...
            },
            {
                ...
                canInteract = function()
                    -- return PlayerData.job.type == 'police' and Config.JailBreak.JailBreakActive
