...
Config.StartLoc = vector4(-195.3282, 6264.7392, 31.489353, 28.70412)  -- Starting Location with target and PED
...
-- ***If you add or remove any of these please also change the math.random line 107 in cl_main.lua***
Config.VehicleCoords = {        -- Locations of where the vehicle can spawn **Chosen from random every time you start a new job**
    ...
    [2] = {coords = vector4(234.12, -2441.61, 6.16, 176.46)},
    ...
    [39] = {coords = vector4(1303.19, 1207.2, 107.57, 0.05)},
    ...
    [46] = {coords = vector4(-182.0, 421.23, 110.76, 192.24)},
    ...
    [52] = {coords = vector4(-2352.8, 294.14, 169.47, 289.02)},
    [53] = {coords = vector4(-3200.19, 1152.86, 9.65, 73.61)},
