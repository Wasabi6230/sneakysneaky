								...
								<div class="col col-md-6 d-flex justify-content-center" style="padding-right: 8px;">
									<div class="card w-100">
										...
										<div class="card-body card-body_ov text-center">
											...
											<p class="ew_txt"><span id="societyBalance">${numberWithSpaces(overviewInfos.balance)}</span> NZD</p>
											<hr>
								...
								<div class="col col-md-6 d-flex justify-content-center" style="padding-left: 8px;">
									<div class="card w-100">
										...
										<div class="card-body card-body_ov text-center">
											...
											<p class="card-text text-center ew_txt"><span class="ew_txtc">Earned:</span> <span id="societyLocalEarned">${numberWithSpaces(overviewInfos.bestEmployee.earned)}</span> NZD</p>
										</div>
									</div>
								</div>
							</div>
