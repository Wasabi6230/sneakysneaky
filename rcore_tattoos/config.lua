...
Config.DefaultMarkerSettings = {
    text = '👺 - Buy Tattoo',
    size = 0.5,
    color = {r=221, g=221, b=221, a=200}, -- Values 0-255 of RGB {red, green, blue, opacity},
...
-- MONEY --
Config.MoneyAccountTypes = {"cash", "bank"} -- Accounts to check if player can afford tattoo, accounts will be checked in the order you write them
...
Config.Shops = {
    {   
        pos = vector3(1324.91, -1651.75, 52.28),
        blip = {
            name = 'Tattoo Shop',
            options = {
                color = 1,
	...
	{   
        pos = vector3(-1152.02, -1425.47, 4.95),
        blip = {
            name = 'Tattoo Shop',
            options = {
                color = 1,
	...
	{   
        pos = vector3(321.01, 182.0, 103.59),
        blip = {
            name = 'Tattoo Shop',
            options = {
                color = 1,
	...
	{   
        pos = vector3(-3171.53, 1074.28, 20.83),
        blip = {
            name = 'Tattoo Shop',
            options = {
                color = 1,
	...
	{   
        pos = vector3(1862.43, 3748.34, 33.03),
        blip = {
            name = 'Tattoo Shop',
            options = {
                color = 1,
	...
	{   
        pos = vector3(-292.11, 6199.77, 31.49),
        blip = {
            name = 'Tattoo Shop',
            options = {
                color = 1,
