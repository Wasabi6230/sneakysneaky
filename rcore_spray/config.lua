...
Config = {
    ...
    SPRAY_PROGRESSBAR_DURATION = 30000,
    SPRAY_REMOVE_DURATION = 40000,
...
IMAGES = {
	...
	-- {
        ...
        -- scale = 0.47,
        -- color = {255, 255, 0},
        -- gangTags = {'kingsmen'}, -- Used for capturing territory when using https://store.rcore.cz/package/4913168
        -- width = 400,
        -- height = 400,
    -- },
	{
        ...
        scale = 0.47,
        color = {206, 250, 5},
        gangTags = {'CMACX'}, -- Used for capturing territory when using https://store.rcore.cz/package/4913168
        width = 400,
        height = 400,
    },
	{
        ...
        scale = 0.47,
        color = {206, 250, 5},
        gangTags = {'MAKZ'}, -- Used for capturing territory when using https://store.rcore.cz/package/4913168
        width = 400,
        height = 400,
    },
}
