...
-- Enables neon for a specific vehicle
-- @param vehicle object - Vehicle object
...
local AlertPolice = function(plate, veh)
    TriggerServerEvent('dispatch:addCall', "10-18", 'STOLEN CAR', {
            icon = 'fa-user-friends', -- ICON CAN YOU USE FROM https://fontawesome.com/
            message = 'A vehicle has been reported as stolen', -- MESSAGE TO DISPLAY
...
-- This functions handling the second part of VIN scratching a vehicle by making an animation and setting the wipedPaperwork variable to true as well as removing qb-target options
...
-- This functions handling the first part of VIN scratching a vehicle by making an animation and setting the connectNetwork variable to true as well as executing the second part of VIN scratching
