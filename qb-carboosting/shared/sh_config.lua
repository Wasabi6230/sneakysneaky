...
Shared.Debug = false -- Server sided console prints

Shared.BoostInterval = 40 -- How many minutes between new boost contracts
...
Shared.Contracts = {
    ['D'] = {
        ...
        locations = { -- You can always add more locations here, vehicle takes a vector4 and peds takes a table of vector3's to spawn the peds
            ...
            [3] = {
                vehicle = vector4(1512.35, -2533.46, 56.42, 56.18),
                peds = {}
            },
            [4] = {
            ...
            [14] = {
                vehicle = vector4(3263.92, 5204.89, 19.97, 191.34),
                peds = {}
            },
            [15] = {
        ...
        maxRep = 250, -- Here you can change the min and max reputation thresholds for the different ranks
        price = {min = 5,  max = 10}, -- Buy-in price in crypto
        reward = {min = 10, max = 15}, -- Crypto rewarded after successful boost
